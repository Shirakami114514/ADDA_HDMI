...
#
# Generated by export_simulation on Fri Feb 18 18:04:06 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './blk_mem_gen_sawtooth.sh' script.

./blk_mem_gen_sawtooth.sh -reset_run
...
./blk_mem_gen_sawtooth.sh -noclean_files

For more information on the script, please type './blk_mem_gen_sawtooth.sh -help'.
