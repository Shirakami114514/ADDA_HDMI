...
HD_PWD='D:/BaiduNetdiskDownload/DA_HDMI/DA_HDMI.runs/blk_mem_gen_square_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_square.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_square.tcl
